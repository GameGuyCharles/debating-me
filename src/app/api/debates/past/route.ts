...
// GET /api/debates/past — List completed debates for public browsing
export async function GET(req: NextRequest) {
  ...
  let query = `
    SELECT d.id, d.topic, d.status, d.total_turns,
           d.user_a_score, d.user_b_score, d.winner_id,
           d.spectator_count, d.created_at, d.completed_at,
           d.replay_slug,
